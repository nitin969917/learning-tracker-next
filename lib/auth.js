                ...
                if (credentials?.googleIdToken) {
                    try {
                        ...
                        if (!user) {
                            ...
                            // Handle educational details if passed (hacky via password field? or just ignore for now in this flow)
                            // Ideally we would separate registration, but for now basic login.
                        } else {
